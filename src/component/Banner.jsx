    ...
    >
      ...
      <div className="hero-content text-neutral-content text-center ">
        <div className="max-w-md">
          ...
          <h3 className="mb-5 text-lg md:text-3xl font-extrabold text-yellow-300">
          ...
          <button className="text-white p-4 border-b-2 border-yellow-400 rounded-b-lg  focus:border-yellow-400 focus:border-2 focus:rounded-lg focus:bg-yellow-300 focus:text-black md:text-xl focus:font-semibold text-sm">
            View All Foods
          </button>
        </div>
      </div>
